...
const Header = () => {
  ...
  const navigationItem = [
    ...
    },
    {
      label: "FURNITURE",
      dropdown: (
        <div className="absolute left-20 right-0 top-full bg-white h-100 shadow-lg p-6 text-sm z-50 w-screen">
  <div className="grid grid-cols-5 gap-8 px-6">
    ...
    <div style={{ marginTop: "-10px" }}>
      ...
      <ul className="space-y-1 text-sm leading-[1.8] w-full">
        <li className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Sofas</a></li>
        <li className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Chairs</a></li>
        <li className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Armchairs</a></li>
        <li className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Dining Room Chairs</a></li>
        <li className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">All Seating</a></li>
      </ul>
    </div>
    ...
    <div style={{ marginTop: "-10px" }}>
      ...
      <ul className="space-y-1 text-sm leading-[1.8] w-full">
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Cabinets</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Dressers</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Night Stands</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Bookcases</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">All Storage</a></li>
      </ul>
    </div>
    ...
    <div style={{ marginTop: "-10px" }}>
      ...
      <ul className="space-y-1 text-sm leading-[1.8] w-full">
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Dining Tables</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Coffee Tables</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Side Tables</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Desks</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">All Tables</a></li>
      </ul>
    </div>
    ...
    <div style={{ marginTop: "-10px" }}>
      ...
      <ul className="space-y-1 text-sm leading-[1.8] w-full">
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Mid Century Modern</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Art Deco</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Louis XVI</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">All Styles</a></li>
      </ul>
    </div>
    ...
    <div style={{ marginTop: "-10px" }}>
      ...
      <ul className="space-y-1 text-sm leading-[1.8] w-full">
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Milo Baughman</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Gio Ponti</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Le Corbusier</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">Ettore Sottsass</a></li>
        <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}><a href="#">All Creators</a></li>
      </ul>
    </div>
  </div>
</div>
        ...
        <div className="p-6 grid grid-cols-3 gap-8 text-sm max-w-screen-xl mx-auto">
          <div>
            ...
            <ul className="space-y-2 text-sm line-height-[1.8]">
              <li  className=" font-sm mt-2 mb-3 hover:underline  " style={{fontWeight:"200", color:"#5f5d5dff"}}>
      ...
      <div className="container mx-auto px-4 py-3">
        ...
        <div className="flex items-center justify-between lg:relative">
          ...
          <div className="hidden lg:flex flex-1">
            <div className="relative inline-block w-full max-w-[220px] focus-within:max-w-[400px] transition-all duration-500 ease-in-out">
              <input
                type="text"
                placeholder="Search"
        ...
        {/* <nav className="hidden lg:flex items-center justify-center gap-8 mt-4 relative">
        ...
        {/* <nav
  className={`hidden lg:flex items-center justify-center gap-8 mt-4 relative transition-all duration-500 ease-in-out ${
    showNav ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-5 pointer-events-none"
  }`}
>
  {navigationItem.map(({ label, dropdown }) => (
    <div key={label} className="relative group">
          ...
          <div className="fixed inset-0 z-50 bg-opacity-50 lg:hidden">
            <div className="w-64 bg-white h-full shadow-md p-4">
              ...
              <div className="flex items-center justify-center gap-2 text-sm">
                <button className="border py-1 px-6 mt-2 hover:bg-black hover:text-white transition duration-300">
                  LOGIN
                </button>
                <span className="text-gray-400">|</span>
                <button className="border py-1 px-6 mt-2 hover:bg-black hover:text-white transition duration-300">
