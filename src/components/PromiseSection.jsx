...
import { ShieldCheck, RotateCcw, BadgeCheck, Store, Scale, Truck } from "lucide-react";
  ...
  return (
    <section className="bg-[#c7d9d9] w-full mx-auto flex flex-col md:flex-row items-start justify-between px-6 md:px-12 py-10 md:py-16">
      ...
      <div className="w-full md:w-1/2 md:pr-10 mb-8 md:mb-0">
        ...
        <p className="text-base md:text-lg text-gray-600 mb-4 leading-relaxed tracking-wide">
        ...
        {promises.map((item, index) => {
          ...
          return (
            <div key={index} className="flex flex-col items-start">
              <Icon className="w-6 h-6 text-teal-900 mb-2" />
